...
class Rossmann_c05( object ):
    ...
    def __init__( self ):
        ...
        self.competition_open_since_year_scaler = pickle.load( open( self.home_path + 'models/competition_open_since_year_scaler.pkl', 'rb' ) )
        self.customers_scaler                   = pickle.load( open( self.home_path + 'models/customers_scaler.pkl', 'rb' ) )
        ...
        self.promo2_since_year_scaler           = pickle.load( open( self.home_path + 'models/promo2_since_year_scaler.pkl', 'rb' ) )
